...
function ArrowButton({ title, onClick }) {
  return (
    <div onClick={onClick} className="hidden md:flex flex-col items-center justify-center w-20 h-20 rounded-full cursor-pointer hover:opacity-50 transition duration-300 gap-1">
